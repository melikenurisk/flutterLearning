...
import 'package:full_learn/202/cache/user_cache/user_cache_manager.dart';
...
class _SharedListCacheState extends LoadingStateful<SharedListCache> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: isLoading ? CircularProgressIndicator(color: Theme.of(context).canvasColor) : null,
        actions: isLoading
            ? null
            : [
                IconButton(
