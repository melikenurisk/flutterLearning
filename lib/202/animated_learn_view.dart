...
class _AnimatedLearnViewState extends State<AnimatedLearnView> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        children: [
          ListTile(
            title: AnimatedOpacity(
                duration: _DurationItems.durationLow, opacity: _isOpacity ? 1 : kZero, child: const Text('data')),
            trailing: IconButton(
                onPressed: () {
                  _changeOpacity();
                },
          ...
          AnimatedDefaultTextStyle(
            ...
            style:
                (_isVisible ? context.textTheme().headlineLarge : context.textTheme().titleMedium) ?? const TextStyle(),
      ...
      //Text('data', style: context.textTheme().titleLCarge),
    );
  }
